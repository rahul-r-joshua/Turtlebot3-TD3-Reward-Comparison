        ...
        while True:
            for i in range(num_keyframes):
                ...
                while time.time() - start_time < delta_time:
                    ...
                    pose.orientation.x = current_orientation[0] 
                    pose.orientation.y = current_orientation[1] 
                    pose.orientation.z = current_orientation[2] 
                    pose.orientation.w = current_orientation[3] 
